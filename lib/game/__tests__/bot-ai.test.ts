...
describe('Bot AI System', () => {
  describe('getBotCards', () => {
    it('should return the correct number of cards', () => {
      ...
      const botCards = getBotCards(count, 'medium', playerDeck);
    ...
    it('should return different cards for different difficulty levels', () => {
      ...
      const easyCards = getBotCards(count, 'easy', playerDeck);
      const mediumCards = getBotCards(count, 'medium', playerDeck);
      const hardCards = getBotCards(count, 'hard', playerDeck);
    ...
    it('should handle easy difficulty with random selection', () => {
      const count = 3;
      const playerDeck = ALL_CARDS.slice(0, count);
      const botCards = getBotCards(count, 'easy', playerDeck);
    ...
    it('should handle hard difficulty with strategic selection', () => {
      ...
      const botCards = getBotCards(count, 'hard', playerDeck);
