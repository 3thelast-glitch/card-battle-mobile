...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    paddingVertical: 20,
    zIndex: 1, // ✅ المحتوى فوق الخلفية
  },

  titleContainer: {
    alignItems: 'center',
    marginBottom: 16,
    zIndex: 10, // ✅ العنوان فوق الخلفية
  },
  ...
  cardsList: {
    flex: 1,
    marginHorizontal: 8,
    zIndex: 10, // ✅ البطاقات فوق الخلفية
  },
  ...
  cardItemContainer: {
    ...
    marginHorizontal: 8,
    marginBottom: 16,
    zIndex: 10, // ✅ كل بطاقة فوق الخلفية
  },
