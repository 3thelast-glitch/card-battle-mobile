...
const styles = StyleSheet.create({
  ...
  cardName: { color: '#e5e7eb', fontSize: 11, fontWeight: '700', textAlign: 'center' },
  statsRow: { flexDirection: 'row', gap: 8 },
  statText: { color: '#d1d5db', fontSize: 11, fontWeight: '600' },
  opponentReadyLabel: { color: '#4ade80', fontSize: 10, fontWeight: '700', marginTop: 4 },
  ...
  waitingBox: { flexDirection: 'row', gap: 10, alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.4)', borderRadius: 12, padding: 12 },
  waitingText: { color: '#9ca3af', fontSize: 13, fontWeight: '600' },
  ...
  resultScore: { color: '#e5e7eb', fontSize: 14, fontWeight: '700' },
  ...
  gameOverTitle: { color: GOLD, fontSize: 32, fontWeight: '900', letterSpacing: 1, marginBottom: 20 },
  finalScoreRow: { flexDirection: 'row', alignItems: 'center', gap: 16 },
